          ...
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="4" xl="3" className="mx-auto mb-4">
              <h6 className="text-uppercase fw-bold mb-4">
                <MDBIcon icon="shirt" className="me-3" />
                ESSENCE OUTFITTERS
              </h6>
              <p>
                Where Style Meets Comfort. Elevate your wardrobe with our
                premium clothing brand, offering timeless designs crafted from
